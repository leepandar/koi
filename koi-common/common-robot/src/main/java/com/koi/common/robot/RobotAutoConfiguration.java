package com.koi.common.robot;

import com.koi.common.robot.handler.DefaultIErrorMessageHandler;
import com.koi.common.robot.handler.IErrorMessageHandler;
import com.koi.common.robot.message.exception.DefaultRobotExceptionMessage;
import com.koi.common.robot.message.exception.IRobotExceptionMessage;
import com.koi.common.robot.message.exception.RobotExceptionNotifyAspect;
import com.koi.common.robot.message.push.DingTalkRobotMessageHandler;
import com.koi.common.robot.message.push.FeiShuRobotMessageHandler;
import com.koi.common.robot.message.push.RobotMessageHandler;
import com.koi.common.robot.message.push.WeChatRobotMessageHandler;
