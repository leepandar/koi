package com.koi.common.i18n.aspect;

import cn.hutool.core.util.ReflectUtil;
import cn.hutool.core.util.StrUtil;
import com.koi.common.core.i18n.Language;
import com.koi.common.i18n.annotation.I18nField;
...
public class I18nAspect {
     ...
     * execution(public * com.koi.base.controller.*.*(..)) 解释：
     * 第一个* 任意返回类型
     * 第三个* 类下的所有方法
     * ()中间的.. 任意参数
     * annotation(com.koi.commons.annotation.log.AccessLog) 解释：
     * 标记了@AccessLog 注解的方法
     */
    @Pointcut("execution(public * com.koi..*.*(..)) && @annotation(com.koi.framework.i18n.annotation.I18nMethod)")
