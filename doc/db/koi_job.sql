/*
 ...
 Source Server         : koi_job
 Source Server Type    : MySQL
 Source Server Version : 50744
 Source Host           : 47.99.109.115:3306
 Source Schema         : koi_job

 Target Server Type    : MySQL
 Target Server Version : 50744
 File Encoding         : 65001

 Date: 14/09/2025 10:40:53
*/
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='组配置';
...
CREATE TABLE `sj_job_executor` (
  ...
  KEY `idx_namespace_id_group_name` (`namespace_id`,`group_name`),
  KEY `idx_create_dt` (`create_dt`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='任务执行器信息';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='DashBoard_Job';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='任务批次';
...
-- ----------------------------
BEGIN;
INSERT INTO `sj_namespace` VALUES (1, 'Default', '764d604ec6fc45f68cd92514c40e9e1a', '', 0, '2025-09-13 09:39:54', '2025-09-13 09:39:54');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='服务器节点';

-- ----------------------------
-- Records of sj_server_node
-- ----------------------------
BEGIN;
INSERT INTO `sj_server_node` VALUES (2, 'DEFAULT_SERVER_NAMESPACE_ID', 'DEFAULT_SERVER', '1966853891630665728', '192.168.1.61', 17888, '2025-09-13 22:20:17', 2, '{\"webPort\":7002,\"systemVersion\":\"1.7.2\"}', NULL, '2025-09-13 22:19:47', '2025-09-13 22:19:47');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sj_system_user` VALUES (1, 'admin', '465c194afb65670f38322df087f0a9bb225cc257e43eb4ac5a0c98ef5b3173ac', 2, '2025-09-13 09:39:54', '2025-09-13 09:39:54');
COMMIT;
